...
|  **_Negrito e itálico aninhado_** |      `** ** e _ _`       |                       Nenhum                          |   **This text is _extremely_ important**  |
|  ***Todo em negrito e itálico***  |        `*** ***`         |                       Nenhum                          |   ***All this text is important***        |
|         <sub>Subscrito</sub>          |      `<sub> </sub>`      |                       Nenhum                          |   This is a <sub>subscript</sub> text     |
|         <sup>Sobrescrito</sup>         |      `<sup> </sup>`      |                       Nenhum                          |   This is a <sup>superscript</sup> text   |
